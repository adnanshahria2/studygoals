...
export const TargetCard: React.FC<TargetCardProps> = ({
    ...
    return (
        <div className="bg-bg-card border border-border rounded-xl mb-4 overflow-hidden">
            ...
            {/* Columns - Responsive Grid: Single Column Mobile, Single Column Desktop (Rows) */}
            <div className="px-3 pb-2 grid grid-cols-1 gap-3">
                {columns.map((col) => {
                    const topics = dateData[col] || [];
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <div className="flex-1 min-w-0 flex flex-col">
                                                ...
                                                {topic.timedNote && (
                                                    <span className="text-[10px] text-accent-orange truncate font-mono flex items-center gap-1 mt-0.5">
                                                        <span className="text-xs">📝</span> {topic.timedNote}
                                                    </span>
                                                )}
                                                {topic.estimatedTime && (
                                            ...
                                            <span
                                                className={`text-xs font-mono flex-shrink-0 ${topic.progress === 100 ? 'text-green-500' : 'text-gray-500'}`}
                                            >
                                                {topic.progress}%
                                            </span>
